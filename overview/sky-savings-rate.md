...
| ----------------------------- | ---------- | -------------------------------- |
| USDC Stablecoins              | 47.6%      | Coinbase Prime                   |
| Short Duration Treasury Bills | 22.2%      | BlackRock, Janus Henderson       |
| Onchain Crypto-Backed Lending | 16.6%      | Morpho, SparkLend, Aave/Horizon  |
...
**USDS** is the stablecoin issued by Sky Protocol — the third-largest stablecoin by outstanding supply, with <!-- USDS_SUPPLY_START -->$11.1B<!-- USDS_SUPPLY_END -->+ in circulation.
