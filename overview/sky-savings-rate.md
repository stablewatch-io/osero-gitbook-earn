...
| Metric                           | Value  |
| -------------------------------- | ------ |
| Total sUSDS Supply               | <!-- SUSDS_SUPPLY_START -->$5.8B<!-- SUSDS_SUPPLY_END --> |
| Total USDS Supply                | <!-- USDS_SUPPLY_START -->$11.3B<!-- USDS_SUPPLY_END --> |
| Sky Protocol AUM                 | <!-- AUM_START -->$15.9B<!-- AUM_END --> |
...
| ----------------------------- | ---------- | -------------------------------- |
| USDC Stablecoins              | 51.4%      | Coinbase Prime                   |
| Short Duration Treasury Bills | 18.9%      | BlackRock, Janus Henderson       |
| Onchain Crypto-Backed Lending | 15.1%      | Morpho, SparkLend, Aave/Horizon  |
| OTC Crypto-Backed Lending     | 8.8%       | Maple, Galaxy, Anchorage Digital |
