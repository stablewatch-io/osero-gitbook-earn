...
| Metric                           | Value  |
| -------------------------------- | ------ |
| Total sUSDS Supply               | <!-- SUSDS_SUPPLY_START -->$5.5B<!-- SUSDS_SUPPLY_END --> |
...
| ----------------------------- | ---------- | -------------------------------- |
| USDC Stablecoins              | 49.0%      | Coinbase Prime                   |
| Short Duration Treasury Bills | 20.2%      | BlackRock, Janus Henderson       |
| Onchain Crypto-Backed Lending | 15.8%      | Morpho, SparkLend, Aave/Horizon  |
