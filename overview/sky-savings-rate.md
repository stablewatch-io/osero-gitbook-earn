...
| Metric                           | Value  |
| -------------------------------- | ------ |
| Total sUSDS Supply               | <!-- SUSDS_SUPPLY_START -->$5.0B<!-- SUSDS_SUPPLY_END --> |
| Total USDS Supply                | <!-- USDS_SUPPLY_START -->$10.4B<!-- USDS_SUPPLY_END --> |
...
| ----------------------------- | ---------- | -------------------------------- |
| USDC Stablecoins              | 49.1%      | Coinbase Prime                   |
| Short Duration Treasury Bills | 20.4%      | BlackRock, Janus Henderson       |
| Onchain Crypto-Backed Lending | 14.6%      | Morpho, SparkLend, Aave/Horizon  |
