...
| **Onchain DeFi positions** | Positions in protocols like Morpho, SparkLend, and Aave/Horizon that can be liquidated with minimal price impact |

Distributors can integrate this feed into their product UI to give users a live view of available liquidity — a transparency feature that is standard at regulated financial institutions but rare in the DeFi space.
